  ...
  return (
    <div>
      ...
      <div className="mb-16 pt-4">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          >
            ...
            <span className="group-hover:underline underline-offset-2 font-medium" style={{ color: "var(--color-gray-700)" }}>
              llms.txt
            </span>
            <span style={{ color: "var(--color-gray-400)" }}>— machine-readable summary for AI agents</span>
          </a>
        </div>
      </div>
      ...
      >
        ...
        <div>
          <p className="text-sm font-medium mb-0.5" style={{ color: "var(--color-brand-700)" }}>
            Foundation: Untitled UI
          </p>
          <p className="text-sm" style={{ color: "var(--color-brand-600)", lineHeight: "1.65" }}>
