 ...
 * `/pages/dashboard/option-1?userRole=public-user`. Falls back to `DEFAULT_USER_ROLE`
 ...
 * static rendering otherwise (Next.js build error). See `app/pages/dashboard/option-1/page.tsx`
