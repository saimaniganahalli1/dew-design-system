    ...
    return (
        ...
        >
            ...
            {shortcut && (
                <div
                    className={cx(
                        "pointer-events-none absolute inset-y-0.5 right-0.5 z-10 hidden items-center rounded-r-[inherit] bg-linear-to-r from-transparent to-[var(--ui-bg-primary)] to-40% pl-8 md:flex",
    ...
    return (
        <TextFieldContext.Provider value={{ inputClassName, wrapperClassName, iconClassName, tooltipClassName, size }}>
            <AriaTextField
                ...
                className={(state) =>
                    cx(
                        "font-barlow group flex h-max w-full flex-col items-start justify-start gap-1.5",
