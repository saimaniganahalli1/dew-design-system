...
export const Avatar = ({
    ...
    return (
        <div
            data-avatar
            className={cx(
                "font-barlow relative inline-flex shrink-0 rounded-[7px]",
        ...
        >
            <div
                className={cx(
                    "relative inline-flex size-full shrink-0 items-center justify-center overflow-hidden rounded-md bg-tertiary outline-[0.5px] -outline-offset-[0.5px] before:inset-[0.5px]",
                    canShowImage ? "outline-black/8" : "outline-[var(--ui-border-secondary)]",
                    rounded && "rounded-full",
                    canShowImage &&
                        size !== "xs" &&
